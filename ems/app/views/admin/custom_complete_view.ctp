...
//echo "<h3>Complete View for selected sections</h3>";

//print_r($selected_sections);
...
<br/><br/>
<div class="report_title"><font size="3" color="#333"><b>Complete View for selected sections</b></font></div><br/>
	...
	?>
		...
		<td >
			...
			elseif($question['Survey']['type'] == "2" || $question['Survey']['type'] == "0" || $question['Survey']['type'] == "3"){
				//$name = "text_".$question['questions']['id'];
				...
				if( empty($ans_radio_text) ) $ans_radio_text="Not Submitted";
				echo $ans_radio_text;
			}
