...
$old_num = "";
	...
	echo '<div class="reports"><br/><br/><div class="report_title">';
		...
		echo "Follow-Up-".$followUpNumber." Survey of Section - ". ($section);
...
<table >
	<tr> 
		<td style="text-align:right">
            ...
            <?php 
				$edit_link = $html->url('/surveys/fedit')."/".$section."/".$factory_id."/".$followUpNumber;
