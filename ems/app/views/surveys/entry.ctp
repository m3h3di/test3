...
<script type="text/javascript">
	...
	function showType2_back(dest , ref){
			...
			<?php		
				...
				if($question['Survey']['type'] == "1" || $question['Survey']['type'] == "2"){
					...
					<tr>
						...
						<td style="text-align:center">
							...
							?>
							<div ><textarea id="" style=";width:90%; height:50px" name="<?php echo $name; ?>"></textarea></div>
						</td>
					</tr>
					<?php
				}
				if( is_array( $question['Answer']) & !empty($question['Answer']) ){
					...
					<tr id="<?php //echo $sub_td_id; ?>">
						<td width="10%"> <input id="<?php echo $detect_id ;?>" name="<?php echo $name ;?>[value]"  style="padding:0;width: 50%;" type="checkbox" onclick="javascript: showfield(this);"/> </td>
						<td >
								<?php 
									echo $ans['answer']; 
									if( trim( strtolower($ans['type']) ) == 1 ){
										$name = "ansdata[".$question['Survey']['id']."][chk][".$ans['id']."][text]";
										echo '<br/><span id="'.$detect_id.'1" style=" display:none;"><input name="'.$name.'" style="padding:0; width: 90%;" type="text"  /></span>';
									}
									elseif( trim( strtolower($ans['type']) ) == 2 ){
										$name = "ansdata[".$question['Survey']['id']."][chk][".$ans['id']."][text]"; ?>
										
                                        <table id="<?php echo $detect_id ?>1" style=" display:none; width:340px">
                                        <tr>
                                        	<td>Amount</td>
                                            <td>Where stored</td>
                                            <td>MSDS</td>
                                        ...
                                        <tr>
                                        	<td><input name="<?php echo $name; ?>[amount]" style="padding:0; width:120px" type="text"  /></td>
                                            <td><input name="<?php echo $name; ?>[where]" style="padding:0; " type="text"  /></td>
                                            <td><input name="<?php echo $name; ?>[msds]" style="padding:0;"  type="checkbox"  /></td>
                                        </tr>
                                        </table>
					...
					<tr>		
                        ...
                        elseif($question['Survey']['type'] == "8" & empty($question['Answer']) ){ ?>
                            ...
                            for($msm=1;$msm<=15;$msm++){
                                echo '<tr>';
                                echo '<td style="text-align:center"><input style="padding:0;width: 70%;" type="text" name="'.$name.'['.$msm.'][name]" /></td>';
                                echo '<td style="text-align:center"><input style="padding:0;width: 70%;" type="text" name="'.$name.'['.$msm.'][value]" /></td>';
                                echo '</tr>';
                            }
                            ?>
                            </table>
