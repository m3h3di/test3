...
<span style="text-align:left; padding-left:20px"><h3>H&M Standard Rating of different facilities</h3></span>
<br />
<div id="chart_div1" ></div>

<span style="text-align:left; padding-left:20px"><h3>WRAP Standard Rating of different facilities</h3></span>
<br />
	...
	if(!empty($factories)){
		...
		<table id="myTable" class="tablesorter" style=" width:97%" >
			...
			<tr>
				...
				<td style=" border:0; padding: 10px;  text-align:center"><b>Rating H&M Standard(%)</b></td>
				<td style=" border:0; padding: 10px;  text-align:center"><b>Rating WRAP Standard(%)</b></td>
	  ...
	  google.load("visualization", "1", {packages:["corechart"]});
		 ...
		 function drawVisualization() {
			 ...
			 comboChart.draw(data_hnm, {width: 950, height: 500,
			   title : 'Compare Rating of Different Facilities (H&M Standard)',
			   vAxis: {title: "Rating(%)", minValue: 0, maxValue: 90},
			   hAxis: {title: "Facility",textPosition:'none', },
				/*chartArea:{left:0,top:0,width:"90%",height:"90%"},*/
			   seriesType: "bars",
			 ...
			 comboChart.draw(data_wrap, {width: 950, height: 500,
			   title : 'Compare Rating of Different Facilities (WRAP Standard)',
			   vAxis: {title: "Rating(%)", minValue: 0, maxValue: 90},
			   hAxis: {title: "Facility",textPosition:'none', },
				/*chartArea:{left:0,top:0,width:"90%",height:"90%"},*/
			   seriesType: "bars",
