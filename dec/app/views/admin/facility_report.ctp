		...
		<div style=";padding:0 0 20px;"><b>View Report By Section</b></div>
			<table width="100%">
				<tr>
                    ...
                    <td style="text-align:center" title="Point Due to X Standard"><b>X</b></td>
					<td style="text-align:center " title="Point Due to Y Standard"><b>Y</b></td>	
			...
			<?php 
			  ...
			  <div style=" background-color:#EBEBEC;float:left;margin:5px 5px 5px 0px;padding:30px ; width:300px;border-radius:8px;-moz-border-radius:8px;-webkit-border-radius:8px;">
					...
					<p style="border-radius:8px;-moz-border-radius:8px;-webkit-border-radius:8px; background:#FFF; padding:20px; font-size:12px">
                        ...
                        <b>X</b> = Factory Point (Due to X standard)<br/>
                        <b>Y</b> = Factory Point (Due to Y standard)<br/><br/>
						...
						= <b><?php	
							...
							echo $res."%";
						?></b><br /><br />
						Rating (X standard in Percentage) <br/>= (<?php echo $total_hnm_point ?>/<?php echo $total_posible_point ?>)*100 % <br/>
						= <b><?php	
							$res = ($total_hnm_point/$total_posible_point)*100 ;
							$res = number_format($res, 2, '.', '');
							echo $res."%";
						?></b> <br /><br />
                        Rating (Y standard in Percentage) <br />= (<?php echo $total_wrap_point ?>/<?php echo $total_posible_point ?>)*100 % <br/>
						= <b><?php	
