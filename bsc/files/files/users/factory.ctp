<?php
$sections = array("General Facility Information","Chemicals/Hazardous Materials Information","Spill Prevention","Spill Response/Emergency Response","Environmental Awareness Training and Training Records","Cleaner Production","Environmental Management Systems (EMS)","Preparation of Action Plan","Spills/Site Contamination","Spill Prevention and Contingency Preparedness Plan","Emergency Response Plan","Environmental Awareness and Training","Cleaner Production","Environmental Management Systems (EMS)");
...
<div >
	...
	<div style=" background-color:#c8d2d8;float:left;margin:5px;padding:40px; width:400px">
		<div style="margin:-30px 0 0 -27px;padding:0 0 20px;"><b>Survey Sections</b></div>
			...
			<tr><td style="text-align:right">
			  ...
			  <div style=" background-color:#c8d2d8;float:left;margin:5px 5px 5px 0px;padding:40px ; width:404px">
					<div style="margin:-30px 0 0 -27px;padding:0 0 20px;"><b>Facility Information</b></div>
					<p>
