...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Compliance Issue', true), array('action' => 'edit', $section['Section']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Delete Compliance Issue', true), array('action' => 'delete', $section['Section']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $section['Section']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Compliance Issues', true), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Compliance Issue', true), array('action' => 'add')); ?> </li>
