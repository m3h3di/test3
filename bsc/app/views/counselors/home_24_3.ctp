...
<div class="company"><!--company start-->
	<div class="company_info"><!--company_info start-->
        ...
        <div class="company_description"><!--company_description start-->
         ...
         <?php echo $html->image('map_comilla.gif', array('alt' => 'map','border'=>'0') );?>
	...
	<div class="company_info"><!--company_info start-->
        ...
        <div class="msg">
            ...
            <div class="msg_body">
                    ...
                    <div class="message_body">
                        ...
                        <?php foreach($notices as $key=>$notice){?>
                            <div class="single_msg">
                                ...
                                <?php  
										$notice_title=$notice['notice_boards']['notice_title']; 
										$notice_id=$notice['notice_boards']['id']; 
								
                    				echo $this->Html->link($notice_title, array('controller'=>'counselors','action' => 'notice_detail',$notice_id))."<br/>";
            					?>
                                </div>
               ...
               <?php $link =  $this->Html->url("/counselors/all_notice"); ?> 
