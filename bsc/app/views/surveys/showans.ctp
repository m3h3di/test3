...
<div class="breadcrumb"><!--breadcrumb start-->
	<div class="welcome_text"><!--welcome_text start-->
            <font size="2">
                ...
                <?php echo $this->Html->link($company_info['name'], array('controller'=>'counselors','action' => 'facility',$company_info['company_id'])); ?> >>
                
                Survey Date:  <b><?php echo strftime("%B,%Y", strtotime($survey_date)); ?>
...
<br />
<!--edited ny nandinee 2011-04-02 start-->
	<?php 
		 $company_id = $company_info['company_id'];
		 $survey_date ;
		
		 $link =  $this->Html->url("/surveys/survey_edit/$company_id/$survey_date");
	?>

<div align="right" style="width:80px; height:30px; font-size:8px;">   
	<input type="button" name="edit_survey" id="edit_survey" onclick="window.location.href='<?php echo $link ?>'"  value="Edit Survey" />
</div>    
<!--edited ny nandinee 2011-04-02 end-->   
