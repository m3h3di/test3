            ...
            <div class="admin_facility_item_body"><!--admin_facility_item_body start-->
                ...
                <?php //echo $this->Html->image('adm_fac_text_underline.gif', array('alt' => 'line','border'=>'0') );?>
                	...
                	<div class="fac_menu_item"><!--fac_menu_item start-->
                     ...
                     <div class="fac_menu_item"><!--fac_menu_item start-->
                        <?php echo $this->Html->link('By Enterprise Characteristics', array('action' => 'bycriteriasingle')); ?> 
                    </div><!--fac_menu_item end-->
            ...
            <div class="admin_facility_item_body"><!--admin_facility_item_body start-->
                ...
                <?php //echo $this->Html->image('adm_fac_text_underline.gif', array('alt' => 'line','border'=>'0') );?>
                    ...
                    <div class="fac_menu_item"><!--fac_menu_item start-->
                     ...
                     <div class="fac_menu_item"><!--fac_menu_item start-->
                        <?php echo $this->Html->link('By Enterprise', array('action' => 'showlist')); ?> 
                    </div><!--fac_menu_item end-->
                    <div class="fac_menu_item"><!--fac_menu_item start-->
                        <?php echo $this->Html->link('By Compliance Issues', array('action' => 'bysection')); ?> 
                    </div><!--fac_menu_item end-->
                     <div class="fac_menu_item"><!--fac_menu_item start-->
                        <?php echo $this->Html->link('By Question', array('action' => 'byquestion')); ?> 
                    </div><!--fac_menu_item end-->
                    <div class="fac_menu_item"><!--fac_menu_item start-->
                        <?php echo $this->Html->link('By Enterprise Characteristics', array('action' => 'bycriteria')); ?> 
                    </div><!--fac_menu_item end-->
