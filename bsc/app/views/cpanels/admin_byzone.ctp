...
<div class="breadcrumb"><!--breadcrumb start-->
    <div class="welcome_text">
		<font size="2">
            ...
            By Multiple Enterprise - By Zone
    	</font>          
    </div>   
...
<div align="right">Please 
	<?php echo $this->Html->link('Click', array('controller'=>'cpanels','action' => 'zone_export'))	?>
	to export
</div>
...
?>
<div align="right">Please 
	<?php echo $this->Html->link('Click', array('controller'=>'cpanels','action' => 'zone_export',$sec));	
	?>
	to export
</div>
<!--to export table end-->
