<div class="companies index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('user2_id');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td>
			<?php echo $this->Html->link($company['User']['name'], array('controller' => 'users', 'action' => 'view', $company['User']['id'])); ?>
		</td>
		<td>
			<?php echo $this->Html->link($company['User2']['name'], array('controller' => 'user2s', 'action' => 'view', $company['User2']['id'])); ?>
		</td>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('List User2s', true), array('controller' => 'user2s', 'action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New User2', true), array('controller' => 'user2s', 'action' => 'add')); ?> </li>
	</ul>
</div>